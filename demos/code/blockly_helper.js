...
function backup_blocks() {
  if ('localStorage' in window) {
    ...
    window.localStorage.setItem('blockly_code_editor', Blockly.Xml.domToText(xml));
...
function restore_blocks() {
  if ('localStorage' in window && window.localStorage.blockly_code_editor) {
      var xml = Blockly.Xml.textToDom(window.localStorage.blockly_code_editor);
